...
public class MainForm extends javax.swing.JFrame {
    ...
    public void initFrame(String username, String host, int port) {
        ...
        this.host = host;
        this.port = port;
        setTitle("Tên người dùng: " + username);
        //Kết nối 
        connect();
    }
...
//        appendMessage(" Đang kết nối...", "Trạng thái", Color.BLACK, Color.BLACK);
        try {
            ...
            appendMessage("Đã kết nối server", "Trạng thái", Color.BLACK, Color.BLACK);
            ...
            appendMessage("[IOException]: " + e.getMessage(), "Lỗi", Color.RED, Color.BLACK);
        }
    }
    ...
    public void getMsgHeader(String header, Color color) {
        ...
        jTextPane1.setCharacterAttributes(MessageStyle.styleMessageContent(color, "Time New Roman", 14), false);
    ...
    public void showOnLineList(Vector list) {
        try {
            ...
            System.out.println("135 mainform");
 ...
 public void setUpComboBox(Vector list) {       // cập nhật danh sách ng dùng onl
        try {
            System.out.println("Hello");
            jComboBox.removeAllItems();
            jComboBox.addItem("Gửi tất cả");
            Iterator it = list.iterator();
            while (it.hasNext()) {
                Object next = it.next();
                jComboBox.addItem((String) next);
            }
    ...
    private void initComponents() {
        ...
        txtpane2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (jTextField1.getText()== null) {
                appendMessage("Vui lòng nhập nội dung tin nhắn", "Lỗi", Color.RED, Color.RED);
            } else {
                String content = username + " " + jTextField1.getText();
                dos.writeUTF("CMD_CHATALL " + content);
                appendMyMessage(" " + jTextField1.getText(), "Bạn tới mọi người");
                jTextField1.setText("");
            }
        } catch (IOException e) {
            appendMessage(" Không thể gửi tin nhắn đi bây giờ, không thể kết nối đến Máy Chủ tại thời điểm này, xin vui lòng thử lại sau hoặc khởi động lại ứng dụng này.!", "Lỗi", Color.RED, Color.RED);
